...
const en: Dict = {
  ...
  "card.moveIn": "Move-in {date}",
  "card.behind": "{n}d behind",
  "card.tight": "tight",
  "card.pastMoveIn": "past move-in",
...
const es: Dict = {
  ...
  "board.filter.At Risk": "En riesgo",
  "board.sort": "Ordenar",
  ...
  "card.moveIn": "Entrada {date}",
  "card.behind": "{n}d de retraso",
  "card.tight": "ajustado",
  "card.pastMoveIn": "entrada vencida",
